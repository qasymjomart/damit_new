...
parser.add_argument('--devices', type=int, default=0, help='GPU to use for training, default is 0')
...
def main():
    ...
    model = ViT3DSimCLR(out_dim=cfg['simclr']['out_dim'], **cfg['model']).to(args.devices)
